...
class Statification(Base, CornettoObject):
    ...
    def __init__(self, s_archive_sha: str, s_designation: str, s_description: str, d_cre_date: datetime,
    ...
    @staticmethod
    def upd_designation(session: Session, s_archive_sha: str, s_designation: str) -> None:
        """
    ...
    @staticmethod
    def upd_nb_item(session: Session, s_archive_sha: str, i_nb_item: int) -> None:
        """
