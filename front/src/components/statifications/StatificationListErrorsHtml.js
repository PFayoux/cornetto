...
class StatificationListErrorsHtml extends React.PureComponent {
  constructor (props) {
    super(props)
    ...
    this.columns = [
      {
        name: 'error_code',
        title: I18n.t('statification.errors_html.error_code')
      },
      {
        name: 'source',
        title: I18n.t('statification.errors_html.source')
      },
      {
        name: 'url',
        title: I18n.t('statification.errors_html.url')
      }
    ]

    this.sorting = [{ columnName: 'source', direction: 'asc' }]
  ...
  getHeight () {
    const size = (48 * (this.props.errors_html.toJS().length + 1)) + 50
  ...
  render () {
    return (
      <div className='statificationlist_short'>
        <Grid rows={this.props.errors_html.toJS()} columns={this.columns} getRowId={getRowId}>
          <SortingState
 ...
 * @type {Object}
 */
StatificationListErrorsHtml.propTypes = {
 ...
 * @type {Object}
 */
StatificationListErrorsHtml.defaultProps = {
  errors_html: []
}
...
export default StatificationListErrorsHtml
